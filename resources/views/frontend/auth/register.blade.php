                      ...
                      <div class="d-flex align-items-center back-direction mb-2 back-signin">
                        ...
                        <form action="{{ route('register.personal.info') }}" class="form-horizontal" id="personal-info-form" method="POST">
                            ...
                            <div class="auth-module-header">
                                ...
                                <p class="mb-0 text-start auth-text mt-12"> {{ __('Already have an account?') }} 
                                    <a href="{{ url('login') }}">{{ __('Sign in here') }}</a>
                                </p>
                                <p class="mb-0 text-start auth-text mt-12">
                                    {{-- <a href="{{ createSsoUrl('register') }}">{{ __('Register with SSO') }}</a> --}}
                                    <a href="{{ createSsoUrl('register') }}">
                                        <img style="max-width: 30px;" class="img img-fluid" src="{{ asset('public/uploads/logos/kemedar.svg') }}">
                                    </a>
                                    <a href="{{ createrRibanoUrl('register') }}">
