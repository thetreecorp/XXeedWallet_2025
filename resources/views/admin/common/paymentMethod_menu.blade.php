    ...
    <div class="box-body no-padding">
        <ul class="nav nav-pills nav-stacked flex-column">
			@if ($currency->type == 'fiat')
                ...
                <li {{ isset($list_menu) && $list_menu == 'paymob' ? 'class=active' : '' }}>
                    <a data-spinner="true" href='{{ url(config('adminPrefix') . '/settings/payment-methods/paymob/' . $currency->id) }}'>{{ __('Paymob') }}</a>
                </li>
                @php
