                ...
                @foreach ($wallets as $wallet)
                    ...
                    <div class="col-12 col-xl-6 mt-19">
                        <div class="balance-box">
                            ...
                            @if(count($calculateFunds) && $wallet->currency?->symbol == 'keme100' && isset($calculateFunds[$wallet->currency?->id]))
                                <div class="d-flex text-danger justify-content-between position-absolute">
                                    <p><span class="mb-0 f-14 leading-20 gilroy-medium">{{ __('Lock') }}</span> {{formatNumber($calculateFunds[$wallet->currency?->id]['locked_amount'])}}</p>
                                </div>
                            @endif
