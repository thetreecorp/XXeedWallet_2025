				...
				<div class="col-12">
					<nav class="navbar navbar-expand-md navbar-light">
						<a class="navbar-brand" href="{{ request()->path() != 'merchant/payment' ? url('/') : 'javascript:void(0)' }}">
							<img class="dark-logo img-none" src="{{ image(settings('logo'), 'logo') }}" alt="{{ __('Brand Logo') }}">
							<img class="light-logo img-none" src="{{ asset('public/uploads/logos/light-logo.png') }}" alt="{{ __('Brand Logo') }}">
                        </a>	
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ms-auto py-4 py-md-0 gilroy-medium nav-align">
                                ...
                                <li class="nav-item">
									<a class="nav-link" href="{{ route('user.send_money.create') }}">{{ __('hp_menu_send') }}</a>
								</li>
                                <li class="nav-item">
									<a class="nav-link" href="{{ route('user.request_money.create') }}">{{ __('hp_menu_equest') }}</a>
								</li>
                                <li class="nav-item">
									<a class="nav-link" href="{{ route('user.deposit.create') }}">{{ __('hp_menu_accept') }}</a>
								</li>
