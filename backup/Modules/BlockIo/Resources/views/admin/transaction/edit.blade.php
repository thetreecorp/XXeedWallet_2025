                                    ...
                                    <div class="pt-4 rounded">
                                        ...
                                        @if ($transaction->total)
                                            <div class="form-group row total-deposit-space">
                                                ...
                                                <div class="col-sm-6">
                                                    <p class="form-control-static">
                                                        @if ((module('BlockIo') || module('TatumIo')) && ($transaction->currency->type == 'crypto_asset') && ($transaction->transaction_type_id == Crypto_Sent || $transaction->transaction_type_id == Crypto_Received))
