                    ...
                    <div class="box-body box-border">
                        ...
                        <form method="POST" action="{{ $url }}" id="crypto_buy_sell_from" enctype="multipart/form-data">
                            ...
                            <div class="d-flex">
                                ...
                                <img class="ml-12 c-dimension img-fluid mtop-5" src="{{ image($transInfo['fromCurrencyLogo'], 'currency') }}" alt="{{ $transInfo['fromCurrencyCode'] }}">
                            </div>
                            ...
                            <div class="d-flex">
                                ...
                                <img class="ml-12 c-dimension img-fluid mtop-5" src="{{ image($transInfo['toCurrencyLogo'], 'currency') }}" alt="{{ $transInfo['currCode'] }}">
                            </div>
                            <div class="mb-font text-break mt-4n">
                            ...
                            @if($transInfo['merchantAddress'])
                                ...
                                <div class="details-curency details-curency-p mt-1n">
                                    <p class="font-16 OpenSans-400 mt-25 pr-28 color-CD">{{ __('Please make payment') }}
                                        <strong class="c-blue color-E8">{{ formatNumber($transInfo['totalAmount'], $transInfo['from_currency']) }} {{ $transInfo['fromCurrencyCode'] }}</strong> {{ __('to our') }}
                                ...
                                <div class="mt-2 text-break d-flex justify-content-center align-items-center">
                                    <span id="merchantAddress"><strong class="color-E8">{{ $transInfo['merchantAddress'] }}</strong></span>
