                ...
                <div class="crypto-box mob-mt-40">
                    ...
                    <div class="box-body box-border pr-28">
                        ...
                        <div class="form-group make-payment">
                            <input type="file" required data-value-missing="{{ __('Please select a file.') }}" name="proof_file" class="form-control form-control-lg input-file-field" id="file">
                        </div>
                        <span id="fileSpan" class="file-error"></span>
                        <div class="mt-next-2 next mt-32">
                           <div class="d-grid">
                                 <button id="bank_payment" type="submit" class="load-btn btn btn-bg-color btn-lg btn-block c-white font-20 OpenSans-600 d-flex justify-content-center align-items-center">
