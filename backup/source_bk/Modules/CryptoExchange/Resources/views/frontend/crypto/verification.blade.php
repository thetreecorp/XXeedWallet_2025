                ...
                <div class="crypto-box mob-mt-40">
                    ...
                    <div class="box-body box-border">
                        ...
                        <div class="d-flex">
                        	...
                        	<img class="ml-12 c-dimension img-fluid mtop-5" src="{{ image($fromCurrency->logo, 'currency') }}" alt="{{ $fromCurrency->code }}">
                        </div>
                        ...
                        <div class="d-flex text-break">
                            ...
                            <img class="ml-12 c-dimension img-fluid mtop-5" src="{{ image($toCurrency->logo, 'currency') }}" alt="{{ $toCurrency->code }}">
                        </div>
