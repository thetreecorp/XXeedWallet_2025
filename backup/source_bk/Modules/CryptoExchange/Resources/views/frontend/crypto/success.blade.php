                    ...
                    <div class="box-body box-border pr-28">
                       ...
                       <div class="d-flex flex-column justify-content-center text-center total-div border mt-46">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="ml-10 mt-2 align-items-center">
                                <img class="c-dimension img-fluid" src="{{ image($transInfo['fromCurrencyLogo'], 'currency') }}" alt="{{ optional($direction->fromCurrency)->code }}">
                            </div>
                        </div>
                       </div>
                       ...
                       <div class="d-flex flex-column justify-content-center text-center total-div border">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <div class="ml-10 mt-2 align-items-center">
                               <img class="c-dimension img-fluid" src="{{ image($transInfo['toCurrencyLogo'], 'currency') }}" alt="{{ optional($direction->toCurrency)->code }}">
                            </div>
                        </div>
                       </div>

                        <p class="mt-2 text-center a-tag track-tag"><strong class="color-E8">{{ __('Track the transaction') }}:</strong> <a href="{{ $transInfo['trackUrl'] }}" target="_blank">{{ $transInfo['trackUrl'] }}</a> </p>
