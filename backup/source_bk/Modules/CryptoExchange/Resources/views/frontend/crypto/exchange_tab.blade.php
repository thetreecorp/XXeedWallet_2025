                ...
                @if (transactionTypeCheck())
                    <nav class="nav-dimension">
                        <div class="navmp nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link active c-off-white padding-a OpenSans-700 crypto crypto_swap active"
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="mt-2 mt-n8-res w-100">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="send_amount" value="{{ $cryptoDirections[0]->min_amount ?? 0.1 }}"
                                            ...
                                            <!-- Button trigger modal -->
                                                <div id="selected-from-currency" class="selected d-flex gap-20" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm">
                                                    @isset($cryptoDirections[0])
                                                    <button type="button" class="btn btn-primary md:ms-2">
                                                        <img id="seleceted-from-image" class="img-fluid rounded-icon set-img" src="{{ image(optional($cryptoDirections[0]->fromCurrency)->logo, 'currency') }}">
                                                        <span class="set-coinname px-2" id="from-selected">{{ optional($cryptoDirections[0]->fromCurrency)->code }}</span>
                                                    </button>
                                                    @endisset
                                                </div>

                                                <input type="hidden" name="from_currency" id="fromCurrencyId" value="{{  isset($cryptoDirections[0]) ? optional($cryptoDirections[0]->fromCurrency)->id : '' }}">
                                    ...
                                    <div class="boxdiv bg-light mx-28 box-bg-two">
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div id="selected-to-currency" class="selected d-flex gap-20" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm-to">
                                                @isset($toCurrencies[0])
                                                <button type="button" class="btn btn-primary md:ms-2"  >
                                                    <img id="seleceted-to-image" class="img-fluid rounded-icon set-imgTo" src="{{ image($toCurrencies[0]->logo, 'currency') }}">
                                                    <span id="to-selected" class="set-coinnameTo px-2">{{ $toCurrencies[0]->code }} </span>
                                                </button>
                                                @endisset
                                            </div>

                                            <input type="hidden" id="toCurrencyId" name="to_currency" value="{{  isset($toCurrencies[0]) ?  $toCurrencies[0]->id : '' }}">
