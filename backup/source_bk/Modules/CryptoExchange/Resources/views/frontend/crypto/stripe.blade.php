                ...
                <div class="crypto-box mob-mt-40">
                    ...
                    <div class="box-body box-border pr-28">
                        ...
                        <div class="form-group next-step form-mb-12 mt-32">
                            <label for="cardNumber"><span class="font-18 font-mob-14 poppins5 c-blublack">{{ __('Card Number') }}</span> </label>
                                ...
                                <div class="form-group mb-0">
                                    <div class="row">
                                        <div class="col-lg-4 pr-4">
                                            <label for="month" class="OpenSans-400 color-E8">{{ __('Month') }}</label>
                                            <div class="month">
                                        ...
                                        <div class="col-lg-4 mt-4 mt-lg-0 pr-4 year">
                                            <label for="year" class="OpenSans-400 color-E8">{{ __('Year') }}</label>
                                        ...
                                        <div class="col-lg-4 mt-4 mt-lg-0">
                                            <div class="form-group cvc">
                                                <label for="cvc" class="OpenSans-400 color-E8">{{ __('CVC') }}</label>
                        ...
                        <div class="mt-next-2 next d-grid">
                            <button class="load-btn btn btn-bg-color btn-lg btn-block c-white font-20 OpenSans-600 d-flex justify-content-center align-items-center standard-payment-submit-btn" id="stripe_payment" type="submit"
                                >  {{ __('Submit') }}</button>
                        </div>
                    </form>
                    </div>
