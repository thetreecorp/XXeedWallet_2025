                                ...
                                <div class="panel-body">
                                    <div>
                                        ...
                                        @if (isset($exchange->email_phone))
                                            <div class="form-group row">
                                                <label class="control-label f-14 fw-bold text-sm-end col-sm-3" for="user">{{ ucfirst($exchange->verification_via)  }}</label>
                                                <div class="col-sm-9">
                                                    <p class="form-control-static f-14">
                                        ...
                                        @if (isset($transaction->transaction_type_id->name))
                                            <div class="form-group row">
                                                <label class="control-label f-14 fw-bold text-sm-end col-sm-3" for="type">{{ __('Type') }}</label>
                                        ...
                                        @if(isset($exchange->file_name) && file_exists(public_path('uploads/files/crypto-details-file/' . $exchange->file_name)) && !empty($exchange->file_name))
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-9">
                                                    <a class="text-info" href="{{ url('public/uploads/files/crypto-details-file', $exchange->file_name) }}" download="{{ $exchange->file_name }}"><i class="fa fa-download"></i>
                                                        {{ $exchange->file_name }}
                                                    </a>
                                                </div>
                                            </div>
