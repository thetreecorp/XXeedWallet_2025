                    ...
                    <nav>
                        <div class="nav-tab-parent d-flex justify-content-center mt-4" styl>
                            ...
                            @if (transactionTypeCheck('crypto_swap'))
                                <a class="tablink-edit text-gray-100 crypto crypto_swap {{ isset($transInfo['exchangeType']) && $transInfo['exchangeType'] == 'crypto_swap' ? 'tabactive' : (isset($exchangeType) && $exchangeType == 'crypto_swap' ? 'tabactive' : '') }}" data-type="crypto_swap" href="#">{{ __('Crypto Swap') }}</a>
                            @endif
                            @if (transactionTypeCheck('crypto_buy_sell'))
                                <a class="tablink-edit text-gray-100 crypto crypto_buy {{ isset($transInfo['exchangeType']) && $transInfo['exchangeType'] == 'crypto_buy' ? 'tabactive' : (isset($exchangeType) && $exchangeType == 'crypto_buy' ? 'tabactive' : '') }}" data-type="crypto_buy" href="#">{{ __('Crypto Buy') }}</a>
                                <a class="tablink-edit text-gray-100 crypto crypto_sell {{ isset($transInfo['exchangeType']) && $transInfo['exchangeType'] == 'crypto_sell' ? 'tabactive' : '' }}" data-type="crypto_sell" href="#">{{ __('Crypto Sell') }}</a>
                            @endif
                            </div>
                        </div>
                    </nav>
                        ...
                        <div class="row mt-8">
                            ...
                            <div class="col-8 col-md-8">
                                <div class="label-top label-top-sendget">
                                    ...
                                    <input type="text" class="form-control input-form-control apply-bg l-s2" name="send_amount" id="send_amount" value="{{ isset($transInfo['defaultAmnt'])  ? $transInfo['defaultAmnt'] : (isset($minLimit) ? $minLimit : 1.0) }}" required onkeypress="return isNumberOrDecimalPointKey(this, event);" oninput="restrictNumberToPrefdecimalOnSendInput(this)">
                        ...
                        <div class="row r-mb-proceed">
                            ...
                            <div class="col-8 col-md-8">
                                <div class="label-top mt-get">
                                    ...
                                    <input type="text" class="form-control input-form-control apply-bg l-s2" name="get_amount" id="get_amount" value="{{ isset($transInfo['finalAmount']) ?  formatNumber($transInfo['finalAmount'], $toCurrency->id) : 0.1 }}" required onkeypress="return isNumberOrDecimalPointKey(this, event);" oninput="restrictNumberToPrefdecimalOnReceiveInput(this)">
                                </div>
                            </div>
