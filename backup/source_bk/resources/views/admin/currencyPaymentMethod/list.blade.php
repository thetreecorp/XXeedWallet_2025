...
@section('head_style')
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('public/admin-v2/customs/css/currency_payment_methods/list.min.css')}}">
...
@push('extra_body_scripts')
	...
	<script src="{{ asset('public/admin-v2/customs/js/currency_payment_methods/list.min.js')}}" type="text/javascript"></script>
	@if (config('mobilemoney.is_active') && $list_menu == 'mobilemoney')
		<script>
			'use strict';
