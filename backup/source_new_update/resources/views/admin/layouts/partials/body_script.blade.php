...
<!-- AdminLTE App -->
<script src="{{ asset('public/admin-v2/templates/js/app.min.js') }}" type="text/javascript"></script>
...
<script src="{{ asset('public/admin-v2/customs/js/body_script.min.js') }}"></script>
@yield('body_script')
