...
Route::group(['middleware' => ['no_auth:users', 'locale']], function () {
    ...
    // custom
    Route::get('register/verify-phone/{country?}/{code?}/{number?}', 'Auth\RegisterController@verifyPhoneNumber')->name('register.verifyPhone.info');
    Route::post('register/check-phone-exist', 'Auth\RegisterController@checkPhoneExist');
    Route::post('register/send-otp-phone', 'Auth\RegisterController@sendCodeToPhone')->name('sendOtpPhoneVerify');
    Route::post('register/submit-active', 'Auth\RegisterController@activeAccount')->name('activeAccount');

    Route::get('register/verify-email/{token}', 'Auth\RegisterController@verifyEmail')->name('register.verifyEmail.info');

    Route::post('register/send-otp-email', 'Auth\RegisterController@sendEmailOtpVerify')->name('send.verifyEmail');
    Route::post('register/active-otp-email', 'Auth\RegisterController@activeEmail')->name('send.activeEmail');
...
Route::get('gateway/paymob/payment','GatewayController@redirectToPaymobLink')->name('paymob.payment');
Route::get('gateway/paymob/verify','GatewayController@paymobVerify');
...
Route::get('/auth/redirect/{provider}', [SocialiteController::class, 'redirectToProvider'])->name('provider.auth');
Route::get('/auth/callback/{provider}', [SocialiteController::class, 'handleProviderCallback'])->name('provider.response');
